...
- Предоставить удобный запус графического интерфейса `rqt_joint_trajectory_controller` для ручного управления суставами через слайдеры.


---

## Примеры узлов и launch-файлы
